...
{
    public class ApiGatewayMethodParameterProvider : IApiGatewayMethodParameterProvider
    {
        protected ILog Log = LogManager.GetLogger(typeof(ApiGatewayMethodParameterProvider));
        private readonly IAmazonAPIGateway gateway;

        public ApiGatewayMethodParameterProvider(IAmazonAPIGateway gateway)
        {
