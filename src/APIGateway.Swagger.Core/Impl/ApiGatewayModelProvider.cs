...
{
    public class ApiGatewayModelProvider : IApiGatewayModelProvider
    {
        private readonly HashSet<string> processedModels;
        private readonly IAmazonAPIGateway gateway;
        protected ILog Log = LogManager.GetLogger(typeof(ApiGatewayModelProvider));

        public ApiGatewayModelProvider(HashSet<string> processedModels, IAmazonAPIGateway gateway, IModelNameResolver modelNameResolver)
        {
