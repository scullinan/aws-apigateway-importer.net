...
{
    public class ApiGatewayMethodProvider : IApiGatewayMethodProvider
    {
        private readonly IApiGatewayModelProvider modelProvider;
        private readonly IApiGatewayMethodResponseProvider methodResponseProvider;
        private readonly IApiGatewayMethodParameterProvider methodParameterProvider;
        private readonly IApiGatewayMethodIntegrationProvider methodIntegrationProvider;
        private readonly HashSet<string> processedModels;
        private readonly IAmazonAPIGateway gateway;
        protected ILog Log = LogManager.GetLogger(typeof(ApiGatewayMethodProvider));

        public ApiGatewayMethodProvider(HashSet<string> processedModels,
            IAmazonAPIGateway gateway,
            IApiGatewayModelProvider modelProvider, 
            IApiGatewayMethodResponseProvider methodResponseProvider, 
            IApiGatewayMethodParameterProvider methodParameterProvider, 
            IApiGatewayMethodIntegrationProvider methodIntegrationProvider)
        {
