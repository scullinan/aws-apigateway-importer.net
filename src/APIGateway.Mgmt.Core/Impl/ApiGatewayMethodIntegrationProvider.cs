...
{
    public class ApiGatewayMethodIntegrationProvider : IApiGatewayMethodIntegrationProvider
    {
        private readonly IAmazonAPIGateway gateway;
        protected ILog Log = LogManager.GetLogger(typeof (ApiGatewayMethodIntegrationProvider));

        public ApiGatewayMethodIntegrationProvider(IAmazonAPIGateway gateway)
        {
